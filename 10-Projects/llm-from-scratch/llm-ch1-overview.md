...
[[llm-from-scratch]] 마스터 플랜의 **Phase 1 / 1장** 정본 노트.
교재: Sebastian Raschka, *밑바닥부터 만들면서 배우는 LLM* — 1장. 대규모 언어 모델 이해하기.
...
책의 그림·표를 본인 말로 1쪽 노트로 재작성 → 핵심 용어 정의 가능.
