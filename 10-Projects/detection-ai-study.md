...
| 4′ | YOLO 라벨링 직접 → 등록 학습 | 신규 — [[../30-References/rnd-dataset-artifacts/03-사용법|YOLO 데이터 규약]] 위에서 진행 | 🔄 **도구 준비 완료** (2026-07-12 — labelme 설치(로컬 필수: 민감 도메인 데이터 웹 업로드 불가) + labelme→YOLO 변환기(체계 강제·검증 완료) + 뼈대·학습기 기존 완비. 남은 것: 라벨링 실습 자체) |
