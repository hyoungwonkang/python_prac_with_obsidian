...
| 2 | 분류 잘하는 법 | **RULE과 겹침** — 고정 test셋에서 Rule vs BERT 등 비교(MLflow) — **다음 착수(순서 1번째)** | [ ] |
